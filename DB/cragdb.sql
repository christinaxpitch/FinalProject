...
START TRANSACTION;
USE `cragdb`;
INSERT INTO `event` (`id`, `event_name`, `description`, `img_url`, `climbing_area_id`, `event_date`, `created_by_user_id`, `created_at`) VALUES (7, 'Crags & Brews', 'A saturday morning group climb in Gregory Canyon. Post climb cooldown at Avery Brewery Company!', 'https://cdn2.apstatic.com/photos/climb/112572084_medium_1494313872.jpg', 3, '2021-05-01 08:30:00', 3, '2020-12-05 08:30:00');
